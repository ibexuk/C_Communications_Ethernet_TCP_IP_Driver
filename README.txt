...
The projects original page on the embedded-code.com web site, which includes a detailed technical manual, can be found at: http://www.embedded-code.com/source-code/communications/ethernet-tcp-ip/ethernet-tcpip-driver
